...
export function helpItems_en() {
    return [
        `<b>Drag & drop tasks and lists as you wish.</b> Edit a task by clicking the task's body. Deleted tasks will be moved 
        to the trash folder.<br><br><b>Change the priority, due date or team member</b> a task is assigned to by simply clicking on it.<br><br>
        ...
        "<b>Show / hide the backlog</b> by clicking the <span class='icon'>&#xead1;</span> Icon.",
        `<b>Show / hide the trash can</b> by clicking the <span class="icon" style="font-family: 'LineAwesome'; font-size: 1.5rem;">&#xf2ed;</span> Icon.<br><br>`,
    ];
}